...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    w: common_vendor.o((...args) => $options.clickHandler && $options.clickHandler(...args), "f5"),
    x: common_vendor.s({
    ...
    C: common_vendor.o((...args) => $options.closeHandler && $options.closeHandler(...args), "4b"),
    D: $options.resolvedCloseColor
  } : {}, {
    E: common_vendor.p({
      mode: "fade",
      show: _ctx.show
